...
<div class="px-2">
    ...
    <div id="content" class="w-full mt-3">
        <div class="bg-gray-100 rounded-md p-2">
            ...
            <hr>
            <div class="my-2">
                <p class="text-center text-lg font-bold">Banjar Bau Aji Barat terdiri dari 29 KK (26 Keluarga dan 3 Muda
                    Mudi)</p>
            </div>
            <hr>
            <div class="my-2">
                ...
                <div class="mt-2 mb-5">
                    <p>B. Iuran perbulan Muda Mudi adalah <strong>75.000</strong>, dibagi menjadi:</p>
                    <table class="w-full">
                        <tr>
                            <td>Iuran BOP</td>
                            <td>40.000</td>
