            ...
            @foreach ($members as $member)
                <div class="bg-blue-200 rounded-md p-2 mb-3 mt-2">
                    ...
                    <div class="my-3 flex flex-row justify-end items-center">
                        <a class="bg-yellow-400 px-3 py-1 mr-3 rounded-sm"
                            href="{{ route('members.edit', [$member]) }}">Edit</a>
                        <a class="bg-red-400 px-3 py-1 rounded-sm" href="javascript:void(0);"
                            onclick='deleteData({{ $member['id'] }}, "{{ route('members.index') }}")'>
                            Delete
